    ...
    <header className="bg-[#2d2735] relative  md:h-100vh md:pb-10 md:pt-2 sm:pb-6 z-10  ">
      {isAboveMediumScreens ? (
        ...
        <section className="flex flex-row justify-between pb-6 relative">
          <article className="flex flex-col text-white justify-evenly text-white-400 absolute top-[20%]  md:top-[28%] sm:top-[5vh] sm:left-[7] left-[14.6%] justify-items-center ">
